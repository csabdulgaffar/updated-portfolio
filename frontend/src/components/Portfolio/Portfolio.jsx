        ...
        <section className="portfolio" id="portfolio">
            ...
            <div className="portfolio-content">
                ...
                <div className="portfolio-items block">
                    ...
                    {/* <div className="links">
                        <a href="https://github.com/csabdulgaffar/thegamingbuild" target="_blank">
                            <i class="fa-brands fa-github"></i> Github Repo
                        </a>
                        <a href="https://github.com/csabdulgaffar/SkillHub" target="_blank">
                            <i className="fas fa-external-link-alt"></i> Live Demo
                        </a>
                    </div> */}
                </div>
                <div className="portfolio-items block">
                    ...
                    {/* <div className="links">
                        <a href="https://github.com/csabdulgaffar/PasswordManager" target="_blank">
                            <i class="fa-brands fa-github"></i> Github Repo
                        </a>
                        <a href="https://github.com/csabdulgaffar/privatecontest.com" target="_blank">
                            <i className="fas fa-external-link-alt"></i> Live Demo
                        </a>
                    </div> */}
                </div>
